                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="card">
                                <div class="card-body">
                                    <h2 class="text-center">Ajouter une université partenaire</h2> <br>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="mb-3 position-relative" id="datepicker1">
                                                            ...
                                                            <input type="text" class="form-control" name="design_partenaire" data-provide="datepicker" data-date-today-highlight="true" data-date-container="#datepicker1">
                                                        </div>
                                                    </div>
                        ...
                        <div class="col-6">
                            <div class="card">
                                <div class="card-body">
                                    <h2 class="text-center">Equipe projet</h2> <br>

                                    <form action="{{route('equipe_projet')}}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane show active" id="datepicker-preview">
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="mb-3 position-relative" id="datepicker1">
                                                            ...
                                                            <input type="text" class="form-control" name="nom_prenom" data-provide=" datepicker" data-date-today-highlight="true" data-date-container="#datepicker1">
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3 position-relative" id="datepicker4">
                                                            <label class="form-label">Partenaires Universités</label>
                                                            <select name="partenaire_id" class="form-control" id="">
                                                            <option value="">Sélectionner</option>
                                                            @isset($partenaires)
                                                                
                                                                @foreach ($partenaires as $partenaire )
                                                                    
                                                                <option value="{{$partenaire->id}}">{{$partenaire->design_partenaire}}</option>
                                                                @endforeach
                                                                @endisset
